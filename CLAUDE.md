...
### Key File Structure
- `app/api/` - API routes for PDF processing, AI generation, user profiles
...
- `app/entry/` - Main directory browsing interface
- `app/outreach/` - Kanban-style outreach management with drag-and-drop
- `app/history/` - Complete archive of all generated outreach messages
...
- Custom font configuration with Geist Sans and Geist Mono
...
- **Email Stages**: sent → responded → in_talks → interviewing → rejected/hired
- **LinkedIn Stages**: sent → responded → connected → ghosted/archived
...
- **Message Details**: View full message content, contact information, and conversation timeline
